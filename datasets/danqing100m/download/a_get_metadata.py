...
OUTPUT_DIR = Path("/tmp/metadata/DanQing100M/parquet")
BATCH_SIZE = 16384
...
def iter_batches(parquet_path):
    ...
    yield from parquet_file.iter_batches(batch_size=BATCH_SIZE, columns=["url", "recaption"])
                ...
                table = pa.table(
                    {
                        ...
                        "caption": batch.column("recaption"),
                    },
