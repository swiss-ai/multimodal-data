"""Convert docvqa dataset: JSONL + spdocvqa_images.tar.gz -> parquet."""
...
JSONL = BASE / "hf___nvidia___Nemotron-Image-Training-v3/docvqa/docvqa.jsonl"
TAR = BASE / "datasets/docvqa/spdocvqa_images.tar.gz"
OUT_DIR = BASE / "swissai___Nemotron-Image-Training-v3/docvqa"
OUT_FILE = OUT_DIR / "docvqa.parquet"
