#!/usr/bin/env python3
"""Split long_responses.jsonl into per-GPU chunk files."""
...
def main():
    ...
    parser.add_argument("--input", type=str, default="outputs/long_responses.jsonl")
    parser.add_argument("--n-chunks", type=int, default=800)
    parser.add_argument("--output-dir", type=str, default="outputs/chunks")
