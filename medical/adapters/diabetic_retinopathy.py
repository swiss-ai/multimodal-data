...
CLASS_CAPTIONS = {
    "No_DR": ("A color fundus photograph of the retina showing no signs of diabetic retinopathy."),
    "Mild": ("A color fundus photograph of the retina showing mild diabetic retinopathy."),
    "Moderate": ("A color fundus photograph of the retina showing moderate diabetic retinopathy."),
    "Severe": ("A color fundus photograph of the retina showing severe non-proliferative diabetic retinopathy."),
    "Proliferate_DR": ("A color fundus photograph of the retina showing proliferative diabetic retinopathy."),
}
