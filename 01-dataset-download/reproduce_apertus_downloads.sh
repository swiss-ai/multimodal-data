...
# 2) Download Medical Multimodal datasets
#
...
echo "1) CoMM Dataset: Follow instructions at https://github.com/HKUST-LongGroup/CoMM"
echo "2) MURA (MSK Xrays): https://stanfordaimi.azurewebsites.net/datasets/3e00d84b-d86e-4fed-b2a4-bfe3effd661b"
echo "3) MRNet (Knee MRI's): https://stanfordaimi.azurewebsites.net/datasets/bface6fc-7859-47d7-a1c8-022cd6b17419"
echo "4) LERA (Lower Extremity Radiographs): https://stanfordaimi.azurewebsites.net/datasets/44a63ddf-edd8-46cb-b021-094bb8efb802"
