#!/usr/bin/env bash
# Convert CoRal train split parquet shards -> SHAR (stage_2)
...
CORAL_PARQUET_DIR=${CORAL_PARQUET_DIR:-/capstor/store/cscs/swissai/infra01/audio-datasets/raw/coral/read_aloud}
SHAR_OUT_DIR=${SHAR_OUT_DIR:-/capstor/store/cscs/swissai/infra01/audio-datasets/SHAR/stage_2/coral_train}
...
echo "=========================================="
echo "CoRal train -> SHAR"
echo "Parquet dir:   ${CORAL_PARQUET_DIR}"
