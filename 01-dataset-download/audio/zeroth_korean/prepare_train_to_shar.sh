#!/usr/bin/env bash
# Convert Zeroth Korean train split parquet shards -> SHAR (stage_2)
...
PARQUET_DIR=${PARQUET_DIR:-/capstor/store/cscs/swissai/infra01/audio-datasets/raw/kresnik___zeroth_korean/data}
SHAR_OUT_DIR=${SHAR_OUT_DIR:-/capstor/store/cscs/swissai/infra01/audio-datasets/SHAR/stage_2/zeroth_korean_train}
