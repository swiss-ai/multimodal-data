...
PROMPT_TEMPLATE = """You are an expert image analyst. Your task is to provide a highly detailed, comprehensive, and accurate description of the provided image.
...
OUTPUT_DIR = Path(__file__).resolve().parent / "outputs" / "uno_1m_v2"
...
def build_prompt(sample: dict) -> str:
    ...
    return PROMPT_TEMPLATE.format(reference_hints="\n".join(reference_lines))
