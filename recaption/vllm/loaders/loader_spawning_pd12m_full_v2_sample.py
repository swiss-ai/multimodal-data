...
from loader_spawning_pd12m_full_v2 import (
    DATASET_ROOT,
    PROMPT,
    SYSTEM_PROMPT,
...
OUTPUT_DIR = Path(__file__).resolve().parent / "outputs" / "spawning_pd12m_full_v2_sample"
...
loader = SimpleNamespace(
    name="spawning_pd12m_full_v2_sample",
