#!/usr/bin/env bash
# Downloads EgoCom dataset from Facebook Research GitHub releases.
#
# Usage:
#   OUTPUT_DIR=/path/to/egocom bash download.sh egocom240p
#
# Available datasets: egocom1080p_uncompressed, egocom720p, egocom480p,
#                     egocom240p, egocom_pretrained_features, egocom_audio_only
