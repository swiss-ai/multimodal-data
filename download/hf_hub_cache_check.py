...
def verify_blob_batch(blob_paths: List[Path]) -> List[Tuple[str, bool, str]]:
    ...
    for blob_path in blob_paths:
        try:
            ...
            message = "OK" if is_valid else "MISMATCH"
...
Examples:
  ...
  %(prog)s --list
    ...
    parser.add_argument("--list", action="store_true", help="List all datasets in cache and exit")
    ...
    # Run verification
    results = verify_cache_optimized(args.cache_dir, args.dataset, args.workers, args.batch_size)
